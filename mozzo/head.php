...
<head>
    ...
    <title>Mozzo - Easier Faster Better</title>
    ...
    <![endif]-->
    <link rel="icon" href="images/ico/mozzo.png">
<!--
...
<body data-spy="scroll" data-target="#navbar" data-offset="0">
    <header id="header" role="banner">
       <a class="navbar-brand" href="index.php"></a>
           <ul class="social-nav">
                <li><a href="https://www.facebook.com/pages/Mozzo/597913756984903"><i class="fa fa-facebook"></i></a></li>
                <li><a href="https://twitter.com/info_mozzo"><i class="fa fa-twitter"></i></a></li>
                <li><a href="https://www.linkedin.com/company/mozzo-pty-ltd"><i class="fa fa-linkedin"></i></a></li>
