...
// Text Block
function mtheme_block_text($block) {
...
//slogan
function mtheme_block_slogan($block) {
	extract( $block, EXTR_OVERWRITE );
	$block_id = 'aq_block_' . $number;
	$block_saving_id = 'aq_blocks[aq_block_'.$number.']';
...
// Slider
function mtheme_block_slider($block) {
	extract( $block, EXTR_OVERWRITE );
	$block_id = 'aq_block_' . $number;
	$block_saving_id = 'aq_blocks[aq_block_'.$number.']';
...
// Google Map
function mtheme_block_googlemap($block) {
	extract( $block, EXTR_OVERWRITE );
	$block_id = 'aq_block_' . $number;
	$block_saving_id = 'aq_blocks[aq_block_'.$number.']';
...
// Portfolio
function mtheme_block_portfolio($block) {
	extract( $block, EXTR_OVERWRITE );
	$block_id = 'aq_block_' . $number;
...
function mtheme_block_featured_portfolio($block) {
	extract( $block, EXTR_OVERWRITE );
	$block_id = 'aq_block_' . $number;
	$block_saving_id = 'aq_blocks[aq_block_'.$number.']';
...
function mtheme_block_widgets($block) {
	extract( $block, EXTR_OVERWRITE );
	$block_id = 'aq_block_' . $number;
	$block_saving_id = 'aq_blocks[aq_block_'.$number.']';
...
function mtheme_block_column($block) {
...
function mtheme_block_clear($block) {
 ...
 */
function mtheme_ajax_slider_handler() {

}

function mtheme_ajax_slider_display() {
