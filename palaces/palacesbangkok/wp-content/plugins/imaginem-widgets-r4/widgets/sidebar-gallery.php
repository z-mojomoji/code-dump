...
class mtheme_SidebarGallery_Widget extends WP_Widget {
	function mtheme_SidebarGallery_Widget() {
		...
		parent::__construct('mtheme_sidebar_gallery', MTHEME_WIDGET_PREFIX . ' - Gallery Widget', $widget_ops);
	}
				...
				case "portfolio" :
					...
					?>
						...
						if ($clickaction=="lightbox" && !post_password_required() ) { ?>
							<a class="postformat-image-lightbox" data-lightbox="magnific-image" href="<?php echo $lightbox_url; ?>" title="<?php echo $imageTitle; ?>">
							<?php
							} else {
							?>
