...
class mTheme_Address_Widget extends WP_Widget {
	...
	function mTheme_Address_Widget() {
		...
		parent::__construct('contact_details',MTHEME_WIDGET_PREFIX .' - '. __('Address', 'mthemelocal'), $widget_ops);
	...
	function widget( $args, $instance ) {
		...
		?>
			...
			<?php if(!empty($email)):?><li><span class="contact_email"><a href="mailto:<?php echo antispambot($email);?>"><?php echo antispambot($email);?></a></span></li><?php endif;?>
			</ul>
		<?php
		echo $after_widget;
