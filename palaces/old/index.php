    ...
    <div class="visible-xs mobile-header">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li class="about_us">
                    <a class="ajax_nav" href="content.php#about" data-html="about-us" data-class="about-us"><span>About us</span></a>
                </li>
                <li class="factory">
                    <a class="ajax_nav" href="content.php#factory" data-html="our-factory" data-class="our-factory"><span>Our Factory</span></a>
                </li>
                <li class="location">
                    <a class="ajax_nav" href="content.php#locationp" data-html="store-locations"><span>Store Locations</span></a>
                </li>
                ...
                <li class="contact_us">
                    <a class="ajax_nav" href="content.php#contact" data-html="contact-us"><span>Contact Us</span></a>
                </li>
            </ul>
            <ul class="bottom-nav">
            	<li>
