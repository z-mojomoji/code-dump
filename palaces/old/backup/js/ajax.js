...
$('.ajax_nav').click(function(event) {
	...
	//$( this ).click(function( event ) {
	  ...
	  //Factory Page
	  if ($( this ).attr( "href" ) == 'content-our-factory.html#factory') {
		  //$('#side-text-id').show();
	  ...
	  //Location Page
	  if ($( this ).attr( "href" ) == 'content-store-locations.html#locationp') {
	  ...
	  //Contact Page
	  if ($( this ).attr( "href" ) == 'content-contact-us.html#contact') {
	...
	//About Page
	  if ($( this ).attr( "href" ) == 'content-about-us.html#about') {
